...
# === PARAMETERS ===
# Use the presence points with features file; coordinates columns are decimalLatitude/decimalLongitude
occ_csv = "data/presence_points_with_features.csv"
